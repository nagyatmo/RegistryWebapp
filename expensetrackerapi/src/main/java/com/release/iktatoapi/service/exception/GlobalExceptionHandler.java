package com.release.iktatoapi.service.exception;

import com.release.iktatoapi.data.entity.ErrorObject;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleException(MethodArgumentTypeMismatchException ex, WebRequest request){
        ...
        eObject.setTimestamp(new Date(System.currentTimeMillis()));
